...
(defn -main []
  (let [stats-ops ns/numeric-stats-ops
        ...
        ;; Test 1: Simple add
        _ (println "\n=== Test 1: Simple adds ===")
        s1 (pss/sorted-set* {:stats stats-ops})
        s2 (conj s1 1 2 3)
        st2 (pss/stats s2)
        ...
        ;; Test 2: Larger set
        _ (println "\n=== Test 2: 100 elements ===")
        s3 (into (pss/sorted-set* {:stats stats-ops}) (range 100))
        st3 (pss/stats s3)
        ...
        s4 (into (pss/sorted-set* {:stats stats-ops :comparator cmp-mod :branching-factor 64})
                 (range 5000))
        st4 (pss/stats s4)
        ...
        s6 (into (pss/sorted-set* {:stats stats-ops}) (range 10))
        st6 (pss/stats s6)
        ...
        _ (println "\n=== Test 6: Large set with branches ===")
        s9 (into (pss/sorted-set* {:stats stats-ops :branching-factor 4}) (range 20))
        st9 (pss/stats s9)
