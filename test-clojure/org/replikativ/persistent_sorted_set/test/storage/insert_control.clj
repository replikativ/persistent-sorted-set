(ns org.replikativ.persistent-sorted-set.test.storage.insert-control
  (:require
   [clojure.test :refer [is deftest testing]]
   [org.replikativ.persistent-sorted-set :as set]
   [org.replikativ.persistent-sorted-set.test.storage :refer [*stats storage]])
  (:import
   [clojure.lang RT]
   [java.lang.ref Reference]
   [java.util ArrayList Collections Comparator Arrays List Random]
   (java.util.random RandomGenerator)
   (org.replikativ.persistent_sorted_set ANode Branch Leaf PersistentSortedSet IStorage Settings)))
