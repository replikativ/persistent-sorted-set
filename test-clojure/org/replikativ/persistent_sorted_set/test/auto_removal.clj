(ns org.replikativ.persistent-sorted-set.test.auto-removal
  ...
  (:import
   ...
   [org.replikativ.persistent_sorted_set ANode Branch IStorage Leaf PersistentSortedSet Settings]))
...
;; Run tests
(comment
  (t/run-tests 'org.replikativ.persistent-sorted-set.test.auto-removal))
