(ns org.replikativ.persistent-sorted-set.test.stats
  (:require
   [org.replikativ.persistent-sorted-set :as set]
   [clojure.test :as t :refer [is are deftest testing]])
  (:import
   [org.replikativ.persistent_sorted_set ANode NumericStats NumericStatsOps]))

(set! *warn-on-reflection* true)

(def stats-ops (NumericStatsOps/instance))

(defn get-root-stats [^org.replikativ.persistent_sorted_set.PersistentSortedSet s]
